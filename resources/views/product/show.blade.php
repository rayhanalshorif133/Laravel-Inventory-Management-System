...
@section('page_index')
<a href="{{route('admin.dashboard')}}">Dashboard </a> &nbsp;/ Product-Show
@endsection
@section('main_content')
<a href="{{route('product.index')}}" class="btn btn-success btn-sm mb-2"><i class="fa fa-arrow-left"></i> Back</a>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 col-sm-6">
                ...
                <div class="col-12">
                    <img src="{{asset('storage/images/'.$product->image)}}" class="product-image p-2"
                        alt="{{$product->image}}">
                </div>
                <div class="col-12 product-image-thumbs">
                    <div class="product-image-thumb active"><img src="{{asset('storage/images/'.$product->image)}}"
                            alt="Product Image">
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6">
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    ...
                    <label class="btn btn-default text-center active">
                        ...
                        {{$color}}
                <br>
                <i class="fas fa-circle fa-2x" style="color:{{$color}}"></i>
                </label>
                @endforeach
            </div> --}}
            ...
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                ...
                <label class="btn btn-default text-center">
                    ...
                    <span class="text-xl">{{substr($size , 0 , 1)}}</span>
                    <br>
                    {{$size}}
                </label>
                @endforeach
            ...
            <div class="bg-gray py-2 px-3 mt-4">
                <h2 class="mb-0">
                    ৳{{$product->price}} <small>({{$product->unite}})</small>
                </h2>
                <h4 class="mt-0">
