<div class="w-100 mx-auto">
    <div class="card card-primary">
        <!-- form start -->
        <form action="{{ route('delivery.update', $deliveryTeam->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control @error('email')
                        ...
                        placeholder="Email" value="{{ $deliveryTeam->email }}">
                    @error('email')
                        <div class="text-danger font-italic">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control @error('address_line_1')
                            ...
                            id="addressLine1" placeholder="Address Line 1" value="{{ $deliveryTeam->address_line_1 }}">
                ...
                <div class="form-row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control @error('area')
                            ...
                            placeholder="Area" value="{{ $deliveryTeam->area }}">
                        @error('area')
                            <div class="text-danger font-italic">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control @error('city')
                            ...
                            placeholder="city" value="{{ $deliveryTeam->city }}">
                        @error('city')
                            <div class="text-danger font-italic">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('address_line_2')
                        ...
                        id="addressLine2" placeholder="Address Line 2" value="{{ $deliveryTeam->address_line_2 }}">
