                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($customerAccountLogs->isEmpty())
                                        <small class="text-danger">No Payment</small>
                                    @else
                                        @foreach ($customerAccountLogs as $customerAccountLog)
                                            @if ($customerAccountLog->order_id === $order->id)
                                                ...
                                                @endphp
                                                <span style="cursor:pointer" class="text-primary showPayment"
                                ...
                                <td>
                                    ...
                                    @endforeach
                                    @if ($getDue == 0)
                                        <small class="text-success">No Due</small>
                                    @else
                                        {{ number_format((float) $getDue, 2, '.', '') }}
                                    @endif

                                    {{-- {{ $countPrice - $ammountPrice }} --}}
                                </td>
                                ...
                                <td>
                                    @if ($getDue == 0)
                                        <span class="text-success">Paid ✔️</span>
                                    @else
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Payment Now</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <form id="editForm" action="" method="POST" enctype="multipart/form-data">
                                ...
                                @enderror
                                <div class="form-group">
                                    <label for="image">Payment Image upload</label><span class="text-danger">*</span>
    ...
    <script>
        $(document).ready(function() {
            ...
            table.on('click', '.editbtn', function() {
                ...
                console.log("ID", id);
                $('#editForm').attr('action', '/customer/' + id + '/payment/');



            });

            table.on('click', '.showPayment', function() {
                $tr = $(this).closest('tr');
                if ($($tr).hasClass('child')) {
                    $tr = tr.prev('parent');
                }
