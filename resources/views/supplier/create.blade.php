                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name')
                            ...
                            id="name" required placeholder="Your full name">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('phone')
                                                                                                                is-invalid
                                                                @enderror" value="{{ old('phone') }}" name="phone"
                            id="phone" required placeholder="Mobile Number" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}">
                        @error('phone')
                            <div class="text-danger font-italic">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('email')
                                                                                                                is-invalid
                                                                @enderror" value="{{ old('email') }}" name="email"
                            id="phone" required placeholder="Email">
                        @error('email')
                            <div class="text-danger font-italic">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control @error('address_line_1')
                                                                                                                    is-invalid
                                                                    @enderror" value="{{ old('address_line_1') }}"
                                name="address_line_1" required id="addressLine1" placeholder="Address Line 1">
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control @error('area')
                                                                                                                    is-invalid
                                                                    @enderror" value="{{ old('area') }}" name="area"
                                required id="area" placeholder="Area">
                            @error('area')
                                <div class="text-danger font-italic">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control @error('city')
                                                                                                                    is-invalid
                                                                    @enderror" value="{{ old('city') }}" name="city"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('address_line_2')
                                                                                                                        is-invalid
                                                                            @enderror"
                            value="{{ old('address_line_2') }}" name="address_line_2" id="addressLine2"
